...
const Navbar = () => {
  ...
  return (
    <div>
      <nav
        className={`fixed top-0 left-0 w-full z-50 px-8 lg:px-[72px] py-8 flex justify-between items-center transition-all ease-in duration-200 ${
          isScrolled ? "bg-primary-500" : "bg-white border-b border-[#F2F2F2]"
        }`}
      >
        <NavLink to={"/berita-kini/"}>
        ...
        <div
          className={`absolute align-middle lg:hidden top-28 right-4 lg:right-0 w-[90svw] bg-white flex flex-col items-center gap-2 shadow-xl rounded-2xl lg:rounded-full transform transition-transform ${
