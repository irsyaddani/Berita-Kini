...
const Navbar = () => {
  ...
  let menuActive = isShow ? "right-0" : "-left-full";
  ...
  return (
    <div>
      <nav
        className={`fixed top-0 left-0 w-full px-8 lg:px-[72px] py-8 flex justify-between items-center transition-all ${
      ...
      >
        ...
        <section className={`hidden lg:flex items-center gap-8`}>
          <a href="#beranda" className="text-body-md-semibold text-primary-500">
            Beranda
          </a>
          <a href="#nasional" className="text-body-md-medium text-[#828282]">
            Nasional
          </a>
          <a
            href="#internasional"
            className="text-body-md-medium text-[#828282]"
          >
            Internasional
          </a>
          <a href="#ekonomi" className="text-body-md-medium text-[#828282]">
            Ekonomi
          </a>
          <a href="#olahraga" className="text-body-md-medium text-[#828282]">
            Olahraga
          </a>
          <a href="#teknologi" className="text-body-md-medium text-[#828282]">
            Teknologi
          </a>
          <a href="#hiburan" className="text-body-md-medium text-[#828282]">
            Hiburan
          </a>
          <a href="#gaya-hidup" className="text-body-md-medium text-[#828282]">
            Gaya Hidup
          </a>
        </section>
        ...
        <button>
          <List
            className={`text-3xl block lg:hidden transition-all ${
        ...
        <div
          className={`absolute z-40 align-middle lg:hidden top-24 right-4 lg:right-0 w-[90svw] bg-white flex flex-col items-center gap-2 shadow-xl rounded-2xl lg:rounded-full transform transition-transform ${
        ...
        >
          <a
            href="#beranda"
            className="w-full text-center p-3 text-body-lg-medium text-primary-500 transition-all"
          >
            Beranda
          </a>
          <a
            href="#Nasional"
            className="w-full text-center p-3 text-body-md-semibold text-[#828282] transition-all"
          >
            Nasional
          </a>
          <a
